...
> **制定日期**: 2026-03-07 | **已完成**: #18-23 | **总题数**: 176 + 22 模板题 + 6 高频补充题 = 204
> **策略**: 专题突破，由易到难，间隔复习
...
| 6 | 164 | Maximum Gap | 🔴 桶排序 O(n)，理解非比较排序 |
...
| 7 | 127 | Word Ladder | 🔴 双向 BFS，字符串 + 图 |
| 8 | 126 | Word Ladder II | 🔴 BFS建图 + DFS回溯，#127 终极版 |
...
| 5 | 309 | Best Time to Buy and Sell Stock with Cooldown | 🟡 状态机 + 冷冻期，股票 DP 变体 |
| 6 | 123 | Best Time to Buy and Sell Stock III | 🔴 至多两次交易，#122 进阶 |
| 7 | 188 | Best Time to Buy and Sell Stock IV | 🔴 至多k次交易，#123 泛化版 |
| 8 | 146 | LRU Cache | 🟡 哈希 + 双向链表，数据结构设计 |
...
> 当前统计按上表合计 **204 题**，本地已建题解/代码覆盖 **145 题**：已完成到一维 DP 的 **#198**；图论覆盖 **6/8**，并查集覆盖 **1/5**，一维 DP 覆盖 **5/10**；`12_图论/07_q127`、`12_图论/08_q126`、`13_并查集/02_q684`-`05_q990`、`14_一维DP/06_q91`-`10_q140` 仍为空目录；Premium/SQL/Shell 已排除
