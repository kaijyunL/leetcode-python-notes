...
> **制定日期**: 2026-03-07 | **仓库覆盖**: 209 / 246 | **总题数**: 246（唯一题号）
> **策略**: 专题突破，由易到难，间隔复习
...
| 9 | 38 | Count and Say（选做） | 🟡 递推模拟，迁移价值较低 | ✅ |
| 10 | 6 | Zigzag Conversion | 🟡 按行分组/周期规律 | ✅ |
| 11 | 43 | Multiply Strings | 🟡 竖式乘法逐位，#67 进阶版 | ✅ |
| 12 | 8 | String to Integer (atoi) | 🟡 状态机/边界处理，面试常考 | ✅ |
| 13 | 65 | Valid Number（选做） | 🔴 完整有限状态机实现，低 ROI | ✅ |
| 14 | 68 | Text Justification（选做） | 🔴 贪心模拟排版，综合模拟能力 | ✅ |
...
> 当前统计按补全后的高频主线题单合计 **246 个唯一题号**；”已覆盖”按仓库内该题已存在本地题解/代码目录统计，去重后共 **209 题**。
---
